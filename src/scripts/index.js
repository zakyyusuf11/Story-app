...
function getBasePath() {
  ...
  if (hostname.includes('github.io')) {
    ...
    // Fallback: coba deteksi dari URL lengkap
    // Jika path dimulai dengan /Story-app/, gunakan itu
    if (path.startsWith('/Story-app/')) {
      console.log('[BasePath] Detected base path from path:', '/Story-app');
      return '/Story-app';
    }
  }
